				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Pulmonology</h2>
				                                <p>The Devaki Speciality Hospital for Respiratory Diseases is manned by the best pulmonologists in Madurai. It is the one of the best chest hospitals in Madurai and deals with all complex problems related to the upper & lower respiratory tract and offers treatment through a multidisciplinary approach.</p>
				                            </div>
				                            <div className="two-column">
				                                <div className="row">
				                                    ...
				                                    <h3>Overview</h3>
				                                    <p>Apart from routine pulmonology, the centre offers thoracoscopy and therapeutic bronchoscopy procedures. The centre hosts a sleep lab, PFT lab, bronchoscopy suite and respiratory support unit with availability of respiratory therapists round-the-clock. The centre also has speciality clinics for cough, asthma, lung cancer and NIV.</p>
				                                    
				                                        <p>We have a team of the best pulmonologists in Madurai who provide specialised services including consultation, diagnosis, and treatment of the pulmonary and respiratory disorders. In addition to the provision of diagnostic imaging and comprehensive treatments for lung diseases, our specialised experts also offer treatment for the following:</p>
				                                        <ul className="list-style-one">
				                                            <li>Asthma</li>
															<li>Snoring & Sleep Apnoea</li>
															<li>Respiratory failure</li>
															<li>Pneumonia</li>
															<li>Interstitial Lung Diseases (ILD)</li>
															<li>COPD</li>
															<li>Chronic cough</li>
															<li>Allergy</li>
															<li>Lung cancer</li>
															<li>Adult Cystic Fibrosis</li>
															<li>Pulmonary treatment</li>
															<li>Acute Bronchitis</li>
															<li>COPD (Chronic Obstructive Pulmonary Diseases)</li>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                    	...
				                                    	<h3>Facilities</h3>
				                                    <span className="theme_color"><b>General</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Health promotion, screening (lung health checks)</li>
																<li>Allergy checks</li>
																<li>Lung health checks (Screening)</li>
																<li>Interstitial lung disease & bronchiectasis clinics</li>
																<li>Lung function tests</li>
																<li>Medical thoracoscopy (for diagnosis and treatment of unilateral pleural effusions)</li>
																<li>Flexible bronchoscopy – including interventional procedures – TBNA, trans bronchial lung biopsies</li>
																<li>Tuberculosis – contact tracing & diagnosis</li>
																<li>Asthma/COPD diagnosis using up-to-date technology</li>
																<li>Dedicated Asthma & chronic cough clinics</li>
																<li>Diagnosis of lung cancer</li>
																<li>Respiratory ICU to manage patients requiring non-invasive ventilation</li>
																<li>Emergency medical care, including intercostal drain insertions</li>
																<li>Home ventilation service (BIPAP, CPAP)</li>
																<li>Oxygen assessment including in-flight oxygen</li>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="pulmonology">Pulmonology</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.Bharathi Babu M.D., D.M., (Pulmo)</a></h4>
				                        	 <span className="designation">Consultant Pulmonologist</span>
				                        </div>
				                    </div>
				                </div>
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.Niranjan M.D., Chest Physicist</a></h4>
				                        	 <span className="designation">Consultant Pulmonologist</span>
				                        </div>
				                    </div>
				                </div>
