				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Pharmacy</h2>
				                                 <span className="theme_color">EASY ACCESS TO LIFESAVING DRUGS. ANYTIME, EVERY TIME.</span>
				                            </div>
				                            ...
				                            <div className="two-column">
				                                <div className="row">
				                                    ...
				                                    <p>Devaki Specialty Hospital has an in-house pharmacy department to ensure that the right medicines are received at the right time, through a highly efficient and economical system. We adopt and apply the best pharmaceutical practices to help maximize drug efficacy and minimize drug toxicity.</p>
				                                    <h3>Facilities</h3>
				                                    <ul className="list-style-one">
			                                            <li>24-hour Pharmacy.</li>
														<li>Quality patient care services.</li>
														<li>Completely computerized system.</li>
														<li>Well-trained and qualified pharmacists.</li>
														<li>Well-stocked with all necessary pharmaceutical and medical products.</li>
														<li>Disposables, surgical, anti-cancer and lifesaving drugs also available.</li>
														<li>Adheres to guidelines as per Drugs & Cosmetics Act of 1948 for Pharmacy Management.</li>
														<li>Genuine medicines from leading manufacturers available round-the-clock.</li>
				                                    </ul>
				                                    <p>Controlled temperature helps in maintaining quality and efficacy of medicines.</p>
				                                </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="pharmacy">Pharmacy</a></li>
