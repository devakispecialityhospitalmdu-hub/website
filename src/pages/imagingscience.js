				    ...
				    <section className="page-title"style={{backgroundImage: `url("assets/images/department.jpg")`}}>
				        <div className="auto-container">
				            <div className="title-outer">
				                <h1>Imaging science & Intervention Radiology</h1>
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Imaging science & Intervention Radiology</h2>
				                            </div>
				                            <p>Devaki Specialty Hospital is recognized as Best hospital that possess all the latest technological advancement when it comes to infrastructure. Our department of Imaging and interventional radiology uses state of the art infrastructure at our facility to not only diagnose diseases but also offers treatment to a variety of conditions using minimally invasive techniques without any scar.</p>
				                            <div className="two-column">
				                                <div className="row">
				                                    
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    <h3>Procedures & Treatments</h3>
				                                    <span className="theme_color"><b>ULTRASOUND IMAGING</b></span>
				                                        <ul className="list-style-one">
				                                            <li>High-end Ultrasound and Colour Doppler</li>
															<li>Abodominopelive imaging</li>
															<li>Obstretive Images</li>
															<li>Thyroid & Brest imaging</li>
															<li>Pedoatric neurosono imagning</li>
															<li>Contrast Ultrasound for characterizing focal lesions in liver, spleen, pancreas and kidneys </li>
				                                        </ul>
				                                        <span className="theme_color"><b>CT IMAGING</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Multiphase Contrast studies with 128 slice CT Scanner</li>
															<li>Multiphase Contrast studies with 64 slice CT Scanner</li>
															<li>Whole body CT Angiography and Venography</li>
															<li>CT Enterography and CT Colography </li>
				                                        </ul>
				                                        <span className="theme_color"><b>MR IMAGING</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Characterizing Hepato-biliary and Pancreatic Lesions, splenic, adrenal, peritoneal, retroperitoneal and GI masses</li>
															<li>MR Cholangiopancreatography (MRCP)</li>
															<li>MR Angiography, Enterography</li>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                    	...
				                                    	<span className="theme_color"><b>INTERVENTIONAL RADIOLOGY</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Biopsy, Drainage, Aspiration</li>
															<li>Biopsies of masses and other body SOL</li>
															<li>Core biopsy for diffuse liver diseases</li>
				                                        </ul>
				                                        <span className="theme_color"><b>CT GUIDED PROCEDURE</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Biopsy, aspiration, drainages</li>
															<li>Biopsy of hepatic, pancreatic and other masses</li>
															<li>Aspiration/Pigtail catheter drainage of Pancreatic and other fluid collections</li>
															<li>Placement of Percutaneous Drainage Catheters (PCD)</li>
															<li>Cholecystostomy</li>
				                                        </ul>
				                                         <span className="theme_color"><b>MAMOGRAPHY</b></span><br></br>
				                                          <span className="theme_color"><b>X-RAY</b></span>
				                                    </div>
				                                </div>
				                            </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="imagingscience">Imaging Science & Intervention Radiology</a></li> 
				            ...
				            <div className="row">
					            ...
					            <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.K.Vijayakumar DMRD., DNB(RD).,</a></h4>
				                        	 <span className="designation">Consultant Radiologist</span>
				                        </div>
				                    </div>
				                </div>
			                ...
			                <div className="row">
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.R.Ravi DMRD.,</a></h4>
				                            <span className="designation">Consultant Radiologist</span>
				                        </div>
				                    </div>
				                </div>
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.K.Rajalakshmi DMRD., </a></h4>
				                        	 <span className="designation">Consultant Radiologist</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.J.Ram Prasad DMRD.,</a></h4>
				                         <span className="designation">Consultant Radiologist</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.D.Kedarnath, MD., DNB., (RD)., (FRCR).,</a></h4>
				                        	 <span className="designation">Consultant Radiologist</span>
				                        </div>
				                    </div>
				                </div>
			                ...
			                <div className="row">
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.N.Naveen MD(RD).,</a></h4>
				                            <span className="designation">Consultant Radiologist</span>
				                        </div>
				                    </div>
				                </div>
