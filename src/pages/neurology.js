				                    ...
				                    <div className="service-detail">
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            ...
				                            <h3>Overview</h3>
				                            <p>Our neurology department provides personalized care for the diagnosis, treatment, and management of several neurological disorders affecting the brain, spinal cord muscles and nerves. We have an integrated team of specialists including Neuro physicians, interventional neurologists, migraine and headache specialists, neurosurgeons, physical and occupational therapists, rehabilitation experts and pain management specialists. Our neurologists deal with the diseases of the spine, brain and the peripheral nerves including epilepsy, stroke, Parkinson’s disease, cerebrovascular diseases (stenosis, AVM, aneurysm), brain and spinal tumours, movement disorders, neuropathies and other degenerative neurological diseases and paediatric neurological disorders.</p>
				                            ...
				                            <div className="two-column">
				                                <div className="row">
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                           ...
				                                           <span className="theme_color"><b>The department has consultant neurologists available. Furthermore, our medical and diagnostic equipment are always updated to match international care standards:</b></span>
				                                    <ul className="list-style-one">
				                                    <li>Sleep laboratory to effectively manage sleep-related problems</li>
				                                    <li>EEG</li>
				                                    </ul>
				                                        <h3>Neurology Department Services</h3>
				                                    <span className="theme_color"><b>General</b></span>
				                                        <ul className="list-style-one">
				                                            <li>24X 7 Acute Stroke Management</li>
															<li>Neuro Intensive Care Unit-Adult & Paediatric</li>
															<li>Adult & Paediatric Neurology Services</li>
															<li>Epilepsy & Movement Disorder Care</li>
															<li>EEG, Neuro Conduction Studies</li>
															<li>Fully Equipped Cathlab for various Neuro Interventions</li>
				                                        </ul>
				                                    </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="neurology">Neurology</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.Muthuveeran M.D., D.M., (Neuro)</a></h4>
				                        	 <span className="designation">Consultant Neurologist </span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
