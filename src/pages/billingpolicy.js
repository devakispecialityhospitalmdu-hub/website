				                    ...
				                    <div className="service-detail">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Billing & Discharge Policy</h2>
				                            </div>
				                            <p>The billing cycle is from midnight to midnight, subject to a minimum of one day's rent. However on the day of discharge, if the patient vacates the room by 2 pm, no room charges shall be levied for that day. 
												</p>
				                                ...
				                                <div className="row">
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                        <p>In case the patient vacates by 6 pm, a half-day room charge shall be levied, and beyond 6 pm, a full-day charge will be levied. The discharge time is subject to the time taken for the discharge summary to be signed by the concerned doctor, payment of the discharge bill, etc. These can vary depending on the days when the doctor is doing OP or cases in Theatre or any unexpected things. The hospital cannot assure a fixed time for the provision of a discharge summary. It is only at the presentation of paid discharge bill at the admitted nursing station, that the discharge summary will be provided to the patient and the discharge process gets completed.</p>
				                            ...
				                            <p>Payments are to be made in advance and whenever intimation for an advance deposit is given to the patient bystanders, they need to pay immediately.</p>

											<p>Cash will be accepted up to Rs 2 lakhs only during one admission to discharge period. All payments of Rs 2 lakhs and above shall be made by the way of transfer to the account of the Hospital by way of RTGS/NEFT/IMPS or any other approved method of transfer. Swiping of cards / Google Pay / Phone Pay / UPI Transfer can also be made. </p>

				                            <p>Repayment of the excess amount remitted will be made through the credit of the party’s account only. For this purpose, the patient/bystander shall provide the IFS code, Account Number, and name of bank and branch, etc at the bill counter while settling the final bill.
												For any problems regarding billing, please contact Billing in-charge or Senior Manager Finance.</p>
				                        ...
				                        <div className="sidebar-widget categories">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    <li><a href="policy">Admission Policy</a></li>
				                                    <li className="active"><a href="billingpolicy">Billing & Discharge Policy</a></li>
				                                </ul>
				                            </div>
				                        </div>				                    
				                        </aside>
