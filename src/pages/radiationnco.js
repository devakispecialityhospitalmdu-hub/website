				...
				<div className="page-wrapper">
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                ...
				                                <span className="theme_color">Bringing you the latest in the fight against cancer.</span>
				                            </div>
				                            <h3>Overview</h3>
				                            <p>The Department of Radiation Oncology at Devaki Specialty Hospital is more than two decades old. Almost 70% of cancer patients require radiation as part of their treatment regime. Patients are managed after incisive consultations with the tumor board comprising surgical oncologists, medical oncologists, pathology oncologists and radiation oncologists.</p>
				                            <p>It also plays a vital role in managing, treating and curing cancer. Radiation Oncology is non-invasive, fast and accurate, often performed as an outpatient procedure. We adhere to international standards of quality with top-of-the-line equipment and quality facilities backed by an experienced team of doctors.</p>
				                            <div className="two-column">
				                                <div className="row">
				                                <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                        <figure className="image pb-5"><a className="lightbox-image"><img src="assets/images/cardiology/cardiology_2.jpg" alt=""/></a></figure>
				                                    	<h3>Other Facilities in Department of Radiation Oncology</h3>
				                                    	<span className="theme_color"><b>Brachytherapy with Image Guidance (IGBT)</b></span>
				                                    	<p>Micro Selectron HDR Brachytherapy is a clinically proven and economical option for treatment in various Cancers.  ICRT (Ca Cervix & Ca Endometrium), ILRT (Ca Oesophagous), Interstitial  (Ca Breast) and Surface Mould Brachytherapy.</p>
				                                    	<p>Brachytherapy is a high precision radiation therapy, in which a radiation source is placed close to the tumour itself, to kill cancer cells and shrink the tumour.  This precision Brachytherapy enables the application of a highly concentrated dose of radiation inside a small area. This   causes less damage to the normal tissues and organs over short periods of exposure.</p>
				                                		<span className="theme_color"><b>Treatment Planning System (TPS)</b></span>
				                                		<p>Computerized Treatment Planning Systems are used in external and internal beam radiation therapy to generate beam shapes for dose distribution. This provides maximum control and minimizes normal tissue complication while providing a 3D view of patient anatomy and tumour. Besides, the CT scan has networking with TPS which makes the treatment procedure highly precise.</p>
				                                		<p>This year we have introduced Stereotactic Radiation therapy to this part of Tamilnadu.</p>	
				                                		<span className="theme_color"><b>Stereotactic Radiation Therapy</b></span>
				                                		<p>A specialized type of external beam radiation therapy called stereotactic radiation uses focused radiation beams targeting a well-defined tumour,  relying on detailed imaging, computerized three-dimensional treatment planning and precise treatment set-up to deliver the radiation dose with extreme accuracy (i.e., stereotactically).</p>
				                                </div>
				                                    
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    	<h3>Facilities</h3>
														<p>The Department of Radiation Oncology, a part of the oncology services in our hospital for nearly Twenty seven years has treated more number of cancer patients with radiation therapy. The department has two Linear Accelerator equipments with advanced facilities like, IMRT (Intensity Modulated RT), IGRT (Image guided Radiotherapy), VMAT – Volumetric Modulated ARC Therapy. VMAT is the first of its kind in South Tamil Nadu. There are a lot of cancer patients who are benefiting with advanced technology as it has very minimal side effects to three Normal tissues.</p>				                                    
				                                    	<h3>Details about the New Technologies</h3>
				                                    	<span className="theme_color"><b>Intensity-modulated radiation therapy (IMRT)</b></span>
							                            <p>IMRT uses the same linear accelerator as conventional therapy but involves dynamic multi-leaf collimators that use movable "leaves" to conform the radiation beam to the shape of the tumor from multiple directions. IMRT greatly enhances the ability to tailor the radiation dose to each patient's individual anatomy. IMRT also allows higher radiation doses to be focused to regions within the tumor while minimizing the dose to surrounding normal critical structures.</p>		                            
							                            <span className="theme_color"><b>Volumetric modulated arc therapy (VMAT)</b></span>
							                            <p>With volumetric modulated arc therapy (VMAT), single or multiple radiation beams sweep around the patient, greatly reducing treatment time compared to conventional radiation treatment. This new technology also offers the radiation oncologist more control and flexibility to deliver a carefully targeted dose so that only the tumor receives a high dose of radiation.</p><br></br>
							                        	<span className="theme_color"><b>Image-guided radiation therapy (IGRT)</b></span>
							                            <p>IGRT combines traditional radiation treatment with a simultaneous CT scan or X-ray to allow for greater precision and accuracy when targeting and treating tumors. IGRT is the process of frequent two and three-dimensional imaging, during a course of radiation treatment, to ensure that the treatment volume is being accurately targeted.</p>
				                                		<h3>Other facilities in the Department</h3>
							                            <ul className="list-style-one">
				                                            <li>VARIAN HALCYON</li>
															<li>Siemens Linear Acceleration 2D & 3D</li>
															<li>Electron beams can be created with high energy LINACS. This is of particular value in treating superficial lesions.</li>
															<li>Brachytherapy</li>
															<li>Treatment planning system</li>
															<li>Mould Room Accessories.</li>
				                                        </ul>
							                        </div>
				   ...
				   {/*} <section className="clients-section alternate">
				    ...
				    <section className="about-section">
				        <div className="auto-container">
				            <div className="row">
				            <div className="content-column col-lg-2 col-md-12 col-sm-12 order-2"></div>
				                <div className="content-column col-lg-8 col-md-12 col-sm-12 order-2">
				                    <div className="inner-column">
				                        <div className="sec-title">
				                            <h3>There are two types of stereotactic radiation.</h3>
				                            <img className="svg" src="assets/images/svgimage.png" alt=""/>
				                            <ul className="list-style-one">
				                                <li>Stereotactic Radio Surgery(SRS) refers to a single or several stereotactic radiation treatments of the brain or spine. SRS is delivered by a team involving a Radiation oncologist and a neurosurgeon.</li>
												<li>Stereotactic Radiation Therapy (SBRT) refers to one or several stereotactic radiation treatments with the body, excluding the brain or spine.</li>
												</ul>
												<p>SRS/SBRT is best for very small tumors. These techniques allow us to give a high dose of radiation to the tumor in a short amount of time. SRS/SBRT is a type of external beam radiation therapy that can be completed in one to five days rather than over several weeks.</p>
												<p>The advantage of SRS/SBRT is it delivers the right amount of radiation to the cancer in a shorter amount of time than traditional treatments. Plus the treatment is delivered with extreme accuracy, minimizing the effect on nearby organs.</p>
				                           	<span className="theme_color"><b></b></span>
				            ...
				            <div className="row">
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    {/*<div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.K.S.Alagappan M.D., (RD)., DNB., (RD)</a></h4>
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.N.Rajaram M.D., RT., (Radiation Oncologist)</a></h4>
				                        	 <span className="designation">Senior Consultant Radiation Oncology </span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    {/*<div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.A.Kirubanithi DMRD.,</a></h4>
				                         <span className="designation">Consultant Radiologist</span>
				                        </div>
				                    </div>*/}
				                </div>
