				...
				<div className="page-wrapper">
				                    ...
				                    <div className="service-detail">
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            ...
				                            <h3>Overview</h3>
				                            	<p>The surgery department is one of the famous departments in Devaki Specialty Hospital. Each unit has sufficient faculties to conduct procedures. Our operation theatres’ were well advanced modular theatre with Laminar Air Flow along with all modern equipment. There are exclusive OT for laparoscopy and minimally invasive surgery. The department also has a full-fledged surgery ICU with 10 beds absolutely for General surgery patients with round the clock service by consultants and specially trained qualified paramedical staff.</p>
				                                <p>To carry out OP procedure and day-care procedure there are separate minor OT adjacent to surgery OP. Apart from General surgery OP, with increasing cases reporting diabetic-related foot issues, there is a separate Diabetic foot clinic. The department also has state of the art Upper & Lower, GI endoscopy suit.</p>
				                                <div>
				                                <div className="row">
				                                	<div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                        <p>We are currently having video endoscopy, Bronchoscopy, Colonoscopy and laparoscopy services. The list is expanding. Each postoperative bed is equipped with ICU back up with central O2 supply, suction machine, and continuous mode of pulse oximeter and infusion pumps.</p>
				                                        <p>A fully-equipped trauma center is in the process. The integrated trauma team approach involves the Department of surgery at the forefront.</p>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="generalsurgery">General Surgery</a></li>
				                                    ...
				                                    <li><a href="criticalcDentalare">Critical Care & Toxicology</a></li>
				   ...
				   {/*} <section className="clients-section alternate">
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.Jagadees Kumar M.S.,</a></h4>
				                        	 <span className="designation">Consultant General Surgeon</span>
				                        </div>
				                    </div>
				                </div>
				            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
			        ...
			        <div className="footer-bottom">
			            <a href="generalsurgery"><div className="scroll-to-top scroll-to-target" data-target="html"><span className="fa fa-angle-up"></span></div></a>
