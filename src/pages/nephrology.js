				                    ...
				                    <div className="service-detail">
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="images-box" style={{"width" : "1070px"}}>
				                            <figure className="image wow fadeIn"><a href="assets/images/resource/service-single.jpg" className="lightbox-image" data-fancybox="services"><img src="assets/images/carousel/4.jpg" alt=""/></a></figure>
				                        </div>
				                        <div className="content-box">
				                            ...
				                            <h3>Overview</h3>
				                            <p>Kidneys play an important role in the human body. They eliminate the waste products generated in the body and maintain fluid and electrolyte balance. They also play part in vitamin D production and prevention of anaemia by generating erythropoietin. Kidney failure can happen due to various reasons like diabetes, hypertension, intrinsic kidney disease, kidney stones, infections, autoimmune conditions, congenital anomalies and hereditary conditions. Kidney failure may require replacement therapy like dialysis and transplantation. We at Devaki Specialty hospital have a full-fledged nephrology department to resolve kidney related problems.</p>
				                            <p>The nephrology department at Devaki Speciality Hospital started in Feb 2016, not only provides preventive advice for safeguarding your kidneys, but also well equipped to deal with all diseases of the kidney which result in kidney failure. The department is supported by full-time consultant nephrologists, junior doctors, dialysis technicians and nurses, dieticians, pharmacists, and secretaries. We have a busy Haemodialysis unit with more than 750 dialysis happening every month. Most health insurance schemes including the Tamilnadu Chief ministers health insurance scheme is available for most renal procedures. We offer both automated peritoneal dialysis and continuous ambulatory peritoneal dialysis for our patients. </p>
				                            <div className="two-column">
				                                <div className="row">
				                                    
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    <h3>Nephrology Department Services offered</h3>
				                                        <ul className="list-style-one">
				                                            <li>24*7 consultancy available for emergencies</li>
															<li>24*7 dialysis facility</li>
															<li>Investigations for renal diseases (laboratory and radiological)</li>
															<li>Hemodialysis unit with separate dialysis machines for hepatitis and HIV patients</li>
															<li>Hemodialysis for COVID-19 affected patients.</li>
															<li>Hemodialysis catheter insertion- temporary and “Permcath”</li>
															<li>AV fistula surgery</li>
															<li>Peritoneal dialysis- CAPD and APD</li>
															<li>Peritoneal dialysis catheter insertion</li>
															<li>Continuous Renal Replacement Therapy (CRRT)</li>
															<li>Plasmapheresis</li>
															<li>Kidney biopsy- Adult and paediatric</li>
															<li>Pediatric hemodialysis & CRRT</li>
															<li>Pediatric peritoneal dialysis</li>
															<li>Extracorporeal therapies for poisoning</li>
															<li>Kidney disease treatment in Pregnancy</li>
															<li>Dietary advice for renal patients</li>
															<li>Kidney disease prevention advice</li>
				                                        </ul>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.J.Dolphin Solomon M.D.,D.M.,(Nephro)</a></h4>
				                        	 <span className="designation">Consultant Nephrologist</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
