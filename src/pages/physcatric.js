				    ...
				    <section className="page-title"style={{backgroundImage: `url("assets/images/department.jpg")`}}>
				        <div className="auto-container">
				            <div className="title-outer">
				                <h1>Physcatric and Counselling</h1>
				                <ul className="page-breadcrumb">
				                    <li><a href="/">Home</a></li>
				                    <li><a href="specialities">Specialities</a></li>
				                    <li><a href="physcatric">Physcatric and Counselling</a></li>
				                </ul> 
				            </div>
				        </div>
				    </section>
				                            ...
				                            <div className="two-column">
				                                <div className="row">
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    	...
				                                    	<span className="theme_color"><b>Psychiatry treatment offered for</b></span>
				                                        <ul className="list-style-one">
				                                            <li>General adult psychiatry</li>
															<li>Addiction psychiatry</li>
															<li>Old-age psychiatry</li>
															<li>Organic psychiatry</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Behaviour Medicine treatment offered for</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Psychosomatic disorders</li>
															<li>Women’s mental health</li>
															<li>Stress disorders</li>
															<li>Anxiety & depressive disorders</li>
															<li>Relationship disorders</li>
															<li>Substance abuse psychiatry</li>
				                                        </ul>
				                                        
				                                        <h3>PSYCHOTHERAUPATIC AND COUNSELLING SERVICES</h3>
				                                        <ul className="list-style-one">
				                                            <li>Cognitive behaviour therapy</li>
															<li>Crisis intervention Counselling</li>
															<li>Somatic Reattribution Counselling</li>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                        ...
				                                        <span className="theme_color">The department provides services in the super specialty fields of psychiatry such as</span>
				                                        <ul className="list-style-one">
				                                            <li>De-addiction Psychiatry – treatment for alcohol dependence / smoking</li>
															...
															<li>Psychotherapeutic and Counseling Services</li>
				                                        </ul>
				                                    </div>
				                                </div>
				                            </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="physcatric">Physcatric & Counselling</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.RamaMoorthy M.S., M.Ch </a></h4>
				                        	 <span className="designation">Consultant Pediatric Surgeon</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
