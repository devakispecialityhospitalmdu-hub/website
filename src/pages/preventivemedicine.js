				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                               ...
				                               <span className="theme_color"> Health Check-up</span><br></br>
				                               <span className="theme_color"> Prevention is better than cure!</span>
				                               <p>The Department of Preventive Medicine at Devaki Specialty Hospital  offers various packages for health checkups. Today’s common people are subjected to far more stress and strain than those at any time in the past. The present day lifestyle makes it mandatory for everyone to undergo a complete health checkup at least once a year. In the West, surprisingly, 50% of patient inflow into hospitals is for preventive health checkups, instead of treatment. Keeping pace with this excellent practice, the department urges people to come in for checkups regularly. Because after all the healthiest attitude to have is one of prevention.</p>
				                            </div>
				                            ...
				                            <div className="two-column">
				                                <div className="row">
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                    	...
				                                    	<h3>Instructions for Master Health Checkup (MHC)</h3>
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
					                                   <h3>Health Check-up Packages</h3>
				                                        <ul className="list-style-one">
				                                            <li>Primary Health Check Up</li>
															<li>Preventive Health Check up </li>
															<li>Diabetic Medical Health Check up (DMHC)</li>
															<li>Cardiac Basic Health Check Up</li>
															<li>Executive Cardiac Master Health Check Up</li>
															<li>Whole Body Health Check up</li>
															<li>Pre-Employment Health Check Up</li>
															<li>Cancer Screening Check up</li>
															<li>Devaki Kidney Check up</li>
				                                        </ul>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="preventivemedicine">Preventive Medicine</a></li>
