				...
				<div className="page-wrapper">
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Internal Medicine, Infectious Diseases & Lifestyle Disorders</h2>
				                            </div>
				                            <p>The Department of General Medicine at DEVAKI SPEICALTY HOSPTAL handles numerous cases each day. This includes patients referred to with conditions difficult to diagnose or ailments that are found to be treatment-resistant. The department diagnoses and treats diseases of the internal organs among patients across all age groups. This includes cases like asthma, allergy, respiratory diseases, COPD, bronchitis, tuberculosis, tropical infectious diseases, hematology related ailments, geriatric care and many more.</p>
				                            <p>Internal medicine specialists or internists deal with a wide range of health conditions that affect adults. They are considered as expert physicians in diagnosing and treating acute and chronic illnesses and also in the prevention of diseases and promotion of health. Internal medicine specialty is not confined to a specific health issue or problems of an organ system – the specialty deals with a comprehensive spectrum of diseases.</p>
				                            <p>A physician who specializes in internal medicine is known as an internist. He deals with the diagnosis of common, rare, simple and complex health conditions. Internal medicine physicians apply their skills, expertise and scientific knowledge to diagnose, treat and take care of patients across a spectrum of health conditions – which may range from simple, infectious, lifestyle disorders to complex illnesses.</p>
				                            <div>
				                                <div className="row">
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
														...
														<li>Acute and chronic respiratory diseases</li>
														<li>Metabolic disorders</li>
														<li>Diabetes</li>
														<li>Tropical diseases</li>
														<li>Sleep disorders</li>
														<li>Allergy and immunological disorders</li>
														<li>HIV and other immune suppressed disorders</li>
														<li>Geriatrics</li>
														<li>Palliative care</li>
				                                   		</ul>
				                                   		<h3 className="pt-4">Procedures performed</h3>
				                                   		<ul className="list-style-one">
				                                   		<li>Bone marrow transplantation</li>
														<li>Aspiration / Biopsy</li>
														<li>Lumbar puncture</li>
														<li>Pleural aspiration</li>
														<li>Ascitic fluid tapping</li>
				                                   		</ul>
				                                    </div>
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    <p>Our internal medicine specialist possesses the expertise to deal comprehensively with a broad spectrum of health conditions that affect adults. They also help in disease prevention and health and well-being promotion. Irrespective of whether the health issue is simple or complex, common or rare, they have the expertise to handle any sort of issue a patient brings.</p>
				                                    <p className="pb-4">They are specially trained to deal with baffling health and diagnostic issues and to manage severe and chronic health conditions – which may come concurrently.</p>
				                                    <h3 className="pt-5">Facilities</h3>
	                                        <ul className="list-style-one">
	                                            <li>Preventive medicine programs</li>
												<li>Comprehensive health-check programs</li>
												<li>Comprehensive woman health check</li>
												<li>Male health check</li>
												<li>Breast cancer screening</li>
												<li>Colon cancer screening</li>
												<li>Basic health check programs</li>
												<li>Preoperative evaluation of patients</li>
												<li>Dietary counselling</li>
												<li>Collaborative Care</li>
												<li>Lung biopsy</li> 
												<li>Bronchoscopy</li>
												<li>Tuberculosis clinic</li>
												<li>FNAC lung and tube thoracotomy</li>
												<li>Comprehensive asthma care clinic</li>
												<li>Computerized pulmonary lung function test</li>
												<li>Pleural biopsy by Cope & Abrams needles</li>
												<li>Asthma and allergy</li>
												<li>Prophylactic vaccination for adults</li>
												<li>Critical care, ICU and ventilator care</li>
	                                        </ul>
	                                        <span className="theme_color">Sub-specialities of general medicine</span>
	                                        <ul className="list-style-one">
	                                        <li>Hematology</li>
	                                        <li>Geriatrics</li>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="generalmedicine">General Medicine</a></li>
				   ...
				   {/*} <section className="clients-section alternate">
			        ...
			        <div className="footer-bottom">
			            <a href="generalmedicine"><div className="scroll-to-top scroll-to-target" data-target="html"><span className="fa fa-angle-up"></span></div></a>
