				        ...
				        <div className="auto-container">
				            <div className="title-outer">
				                ...
				                <ul className="page-breadcrumb">
				                    ...
				                    <li><a href="obstetrics">Obstetrics and Gynaecology</a></li>
				                </ul> 
				            </div>
				        </div>
				    </section>
				                    ...
				                    <div className="service-detail">
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            ...
				                            <p>Devaki Specialty Hospital women and childcare unit provides comprehensive services ranging from general woman’s health checks, adolescent gynaecology urogynaecology and preventive care to a wide range of gynaecological issues that require medical and surgical care.</p>
				                            <div className="two-column">
				                                ...
				                                <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                        ...
				                                        <ul className="list-style-one">
				                                            <li>A gynaecological laparoscopy can be used to detect different conditions and also treat the conditions causing symptoms.</li>
															<li>Abnormalities in the uterus and ovaries can be identified by laparoscopy.</li>
															<li>Blockages, endometriosis, irregularities and scarring of fallopian tubes can be detected by laparoscopy</li>
															<li>Laparoscopy can also be useful in investigating whether there is cancer or it has spread.</li>
															<li>Laparoscopy can be used as diagnostic hystero-laparoscopy (as a part of infertility workup).</li>
															<li>Laparoscopic Surgery (Minimally Invasive Surgery)</li>
															<li>Laparoscopy for tube ligation.</li>
															<li>To check & treat conditions like cysts (Ovarian Cyst Removal) and infections.</li>
															<li>To check & treat conditions like fibroids, pelvic inflammatory disease (PID) endometriosis, and ectopic pregnancy.</li>
															<li>Scars can develop due to endometriosis or after pelvic inflammatory disease. Laparoscopic surgery helps in removing scar tissues (adhesions).</li>
															<li>Laparoscopic Myomectomy (Removal of Fibroids from the Uterus).</li>
															<li>Laparoscopic hysterectomy.</li>
				                                        </ul>
				                                    </div>
				                                  
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    	<p>We also offer care during women’s productive period (reproductive years) and during menopause and post-menopausal years by keeping in view of their social and emotional concerns. We have the best obstetricians and gynaecologists in Vellore who work closely with other specialists including uro-gynaecologists, infertility specialists, surgical oncologists, medical and radiation oncologists. Our department of top gynaecologists in Vellore takes care of mid-life and post-menopausal women by supportive clinics and counselling. We offer a wide range of preventive, diagnostic, therapeutic and ancillary and supportive care and services.</p>
				                                    	<p>Offering care at every stage of woman’s life – pubertal, child-bearing age, pregnancy, childbirth and menopause.</p>				                                   
				                                    <h3>obstetric-care</h3>
				                                    <p>Hospital multidisciplinary team of the best obstetricians in Madurai and excellent facilities makes it the best women and child care centre in Madurai. Our specialists have the expertise to handle any emergency and high-risk pregnancies. The foetus is usually electronically monitored throughout the labour.</p>
				                                    <p>For pregnancies that require extra care Devaki Specialty Hospital state-of-the-art facilities (equipped to handle any emergencies) offers the much-needed support and care.</p>
				                                    <h3>Facilities</h3>
				                                        <ul className="list-style-one">
				                                            <li>Prenatal and Pregnancy care</li>
															<li>Experienced labour and supportive staff</li>
															<li>Rooming in facility</li>
															<li>Trained and skilled obstetricians</li>
															<li>Low nurse to patient ratio</li>
															<li>Blood bank</li>
															<li>All labour rooms and birth centres are well-equipped</li>
															<li>Neonatal Emergency Care</li>
															<li>Neonatal Intensive Care Units</li>
															<li>Family planning counselling</li>
															<li>Diet counselling</li>
															<li>Pain management centre</li>
				                                        </ul>
				                                    </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="obstetrics">Obstetrics & Gynecology</a></li>
				            ...
				            <div className="row">
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.Vijayalakshmi M.D.,OG., </a></h4>
				                            <span className="designation">Consultant Obstetrician and Gynaecologist</span>
				                        </div>
				                    </div>
				                </div>
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr. J.Rekha, M.S.,OG.,</a></h4>
				                        	 <span className="designation">Consultant Obstetrician and Gynaecologist</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.Hemaleka, DGO., DNB., (Fellowship in Infertility) </a></h4>
				                         <span className="designation">Consultant Obstetrician and Gynaecologist</span>
				                        </div>
				                    </div>
				                </div>
