				    ...
				    <section className="page-title"style={{backgroundImage: `url("assets/images/department.jpg")`}}>
				        <div className="auto-container">
				            <div className="title-outer">
				                <h1>Surgery & Surgical Gastroenterology</h1>
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Surgery & Surgical Gastroenterology</h2>
				                                <span className="theme_color">Technology and care hand in hand.</span>
				                                <p>The Department of Surgery & Gastroenterology at Devaki Specialty Hospital provides specialized surgical, interventional endoscopic and advanced laparoscopic services. This department provides comprehensive care through a coordinated approach. Our experienced surgeons are backed by physicians skilled in state-of-the-art diagnostic procedures like Endoscopy, Colonoscopy, etc.</p>
				                            </div>
				                                ...
				                                <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
							                            ...
							                            <ul className="list-style-one">
				                                            <li>Hemoclip</li>
															<li>Heater probe</li>
															<li>Cyanoacrylate glue</li>
															<li>Argon plasma coagulation</li>
															<li>Pentax video system with a dedicated C-ARM</li>
															<li>Video endoscopy system and a high definition Laparoscopy system</li>
				                                        </ul>
				                                        <h3>Surgical Gastroenterology</h3>
				                                		<ul className="list-style-one">
														<li>Laparoscopic Gallbladder surgeries</li>
														<li>Lap appendectomy</li>
														<li>Colon-rectal surgery</li>
														<li>Liver resections</li>
														<li>Pancreatic resections</li>
														</ul>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="surgery">Surgery & Surgical Gastroenterology</a></li>
