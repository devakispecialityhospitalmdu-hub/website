				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>ENT</h2>
				                                <span className="theme_color">DEPARTMENT OF ENT AND FACIAL PLASTIC SURGERY COMBINE THE EXPERTISE OF THE BEST SPECIALISTS WITH STATE-OF-THE-ART DIAGNOSTIC EQUIPMENT AND SURGICAL TECHNOLOGY TO PROVIDE ADVANCED TREATMENT OPTIONS TO OUR PATIENTS.</span>
				                            </div>
				                                ...
				                                <div className="row">
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                        <p>Services Offer in ENT</p>
				                                        <ul className="list-style-one">
				                                            <li>Paediatric Otorhinolaryngology</li>
															<li>Facial Plastic Surgery</li>
															<li>Otology and Neuro-Otology</li>
															<li>Rhinology and Laryngology</li>
															<li>Allergy and Immunology</li>
															<li>Head and Neck Surgical Oncology</li>
				                                        </ul>
				                                    </div>
				                                </div>
				                            </div>
				                            <h3>Service and Facilities </h3>
				                            <p>The ENT Diagnostic Centre is equipped with state-of-the-art Video endoscopy, Video Nasal Endoscopy, Video Laryngoscopy, Video Bronchoscopy, Stroboscopy, Video Electro Nystagmography, Audiometry, and BERA.</p>
				                            <h3>Treatment and Procedures </h3>
		                                        <ul className="list-style-one">
		                                            <li>Medical Otorhinolaryngology</li>
													<li>Surgical Otorhinolaryngology</li>
													<li>ENT-Radiology</li>
													<li>Ear Problems</li>
													<li>Nose Problems</li>
													<li>Endoscopic Skull Base Surgery Pediatric Otorhinolaryngology</li>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    <li className="active"><a href="ent">ENT</a></li>
				        ...
				        <h4 className="text-center">Our Doctors</h4><br></br>
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    {/*<div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a href="doctor-detail">Dr.R.A.Janarthanan M.D., D.M</a></h4>
				            ...
				            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
			                    <div className="inner-box">
			                        ...
			                        <div className="info-box">
			                            <h4 className="name"><a>Dr.Ranjinikanth M.S., ENT</a></h4>
			                         <span className="designation">Consultant ENT</span>
			                        </div>
			                    </div>
			                </div>
				            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
			                    {/*<div className="inner-box">
			                        ...
			                        <div className="info-box">
			                            <h4 className="name"><a href="doctor-detail">Dr.M.Saravanan M.D., D.M</a></h4>
			                        	 <span className="designation">Consultant Cardiologist</span>
			                        </div>
			                    </div>*/}
			                </div>
