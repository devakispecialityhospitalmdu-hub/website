		...
		return (
			...
			<header className="main-header header-style-two">
				     ...
				     <section className="page-title" style={{backgroundImage: `url("assets/images/contact/header.jpg")`}}>
				        ...
				        <div className="auto-container" style={{backgroundImage: `url("assets/images/icons/pattern-1.png")` ,   backgroundPosition: 'center',
			                	...
			                	<div className="content-column col-lg-8 col-md-12 col-sm-12 order-2">
				                    <div className="inner-column">
				                        <div className="sec-title">
				                            <h2 className=" mt-5">Admission Policy for Elective Admissions</h2>
				                            <img className="svg" src="assets/images/svgimage.png" alt=""/>
				                            <ul className="list-style-one">
	                                            <li>Admission Desk is situated at the ground floor of B Block.Admissions are accepted 24X7 irrespective of holidays based on the services provided in Lisie Hospital and based on the availability of the beds.</li>
	                                            <li>Admissions are accepted 24X7 irrespective of holidays based on the services provided in Lisie Hospital and based on the availability of the beds.</li>
	                                            <li>All patients shall make necessary financial arrangements (advance payment) prior to admission. Minimum 50% of the estimate.</li>
	                                            <li>Admissions from Monday to Saturday are done from 7.00 am to 8.00 pm through the Admission desk situated in the ground floor of B Block.</li>
	                                            <li>Admissions from Monday to Saturday from 8.00 pm to 7.00 am next day are done at B Block.</li>
	                                            <li>Admissions on Sunday and other holidays are done at B Block.</li>
	                                            <li>Patients who need immediate care will have the precedence in admission over other patients.</li>
	                                            <li>Admission room shall provide an estimate of the costs of the procedures where expected LOS is known. This estimate is subject to variation due to the length of surgery, number of days spent in the ICU, change treatment regime etc.</li>
	                                            
	                                        </ul>
				                       		<br></br>
				                            <h2 >Policy for Admissions through Emergency Department</h2>
				                            <img className="svg" src="assets/images/svgimage.png" alt=""/>
				                            <ul className="list-style-one">
	                                            <li>ED is situated in the ground floor of the B block.</li>
	                                            <li>Emergency admissions are accepted 24X7 at the ED.</li>
	                                            <li>Since the admission through ED is not planned, provision of bed upon admission might take some time.</li>
	                                            <li>Patient admitted shall be shifted to the room/ward along with a ward boy.</li>
	                                            <li>Patients who need immediate care will have the precedence in admission over other patients.</li>
	                                            <li>The PRO shall provide an estimate of the costs of the procedures where expected LOS is known. This estimate is subject to variation.</li>
	                                            <li>While admitted to the ICU, it is the bystanders’ responsibility to safeguard the valuables of the patients.</li>
	                                            <li>When a patient comes to the ED and beds are not available in any category, the patient shall be sent to the nearest and suitable hospital of the choice of the patient after stabilizing him / her in our ED.</li>
