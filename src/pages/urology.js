				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Urology</h2>
				                                <p>Our Expert Team with the Latest Cutting-Edge Technology Offers Minimally Invasive Solutions to All Urological Problems Ranging From Stone Disease, To Prostate Disease and Advanced Tumors</p>
				                            </div>
				                            <div className="two-column">
				                                <div className="row">
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    	<span className="theme_color"><b>The following urological diseases are treated/ urological procedures are done commonly</b></span>
							                            <ul className="list-style-one">
				                                            <li>Stone Disease</li>
															<li>Urological Cancers (kidney, bladder, prostate, adrenal, ureter, penis, etc.)</li>
															<li>Enlarged Prostate</li>
															<li>Kidney Failure requiring kidney transplantation/ vascular access for hemodialysis</li>
															<li>Pediatric Urological diseases including PUJ obstruction, VUR, etc.</li>
															<li>Andrology, Male Infertility and Men’s Health</li>
															<li>Urinary Incontinence</li>
															<li>Reconstructive Urology</li>
															<li>Urethral Stricture</li>
															<li>Female Urology and Pelvic Health</li>
														</ul>
														<h3>The conditions treated include the following</h3>
														<ul className="list-style-one">
															<li><span className="theme_color">Small capacity bladders</span> - Bladder capacity is increased using the intestine</li>
				                                            <li><span className="theme_color">Recto-urethral or recto-vesical fistulae</span> - Abnormal communications of the urinary tract and food passage</li>
				                                            <li><span className="theme_color">Pelvic fracture urethral injury (distraction defect)</span> - Total cut-off of the urethra following fracture of the hip bone requiring complex operations to re-establish the continuity</li>
				                                            <li><span className="theme_color">Hypospadias</span> - A condition where the urethral opening is not in its usual position and can be placed in the penis or scrotum, leading to difficulty in passing urine. This is corrected by an operation to bring it back to its usual position</li>
				                                            <li><span className="theme_color">Damage to the ureter</span> - Damage to the tube connecting kidney to bladder due to various causes and a new ureter is made from the small intestine</li>
				                                            <li><span className="theme_color">Bladder neck incompetence</span> - Failure to have urine control, requiring complex reconstruction.</li>
														</ul>
				                                ...
				                                <h3>Stricture urethra</h3>
														<p>Urethral damage after endoscopic urethral surgery also undergo corrective surgery in the form of urethroplasty using oral mucosal graft.</p>
														<p>Patients with long segment block in their urethra or failed repeated operations in the form of corrective urethroplasty</p>
				                                </div>
				                                </div>
				                            </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="urology">Urology</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.Velayutham M.S., DNB., (Urology)</a></h4>
				                        	 <span className="designation">Consultant Urology & Laproscopist</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
