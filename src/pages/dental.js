				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Dental</h2>
				                                <span className="theme_color">DENTAL DEPARTMENT IS AT THE HELM OF DENTAL CARE IN MADURAI AS IT OFFERS THE BEST DENTAL TREATMENT IN GENERAL, COSMETIC, IMPLANT DENTISTRY AND ORTHODONTICS. A COMPREHENSIVE RANGE OF DENTAL TREATMENT IS OFFERED IN ALL SPECIALITIES OF DENTISTRY BY A TEAM OF EXPERT DENTISTS.</span>
				                            </div>
				                            <div className="two-column">
				                                <div className="row">
				                                <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    <h3>Overview</h3>
				                                        <p>Dental Department is well-equipped for dealing with a broad spectrum of dental problems ranging from toothache, bleeding gums, bad breath, stained teeth to cosmetic dental surgery and maxillofacial surgeries. The dental centre takes care of emergency dental care services as well. Our senior consultant dental surgeons, orthodontists, periodontists, and maxillofacial surgeons form a multidisciplinary dental team – which work in accordance with some of the best dental standards and practices in the city. Our dental team specializes in all sorts of dental procedures including orthodontic treatment (dental braces). Dental implants, cosmetic dentistry, periodontal treatments (flap surgery), oral surgery, paediatric dentistry and many more.</p>
				                                        
				                                        <h3>Dental Treatments & Procedures</h3>
				                                        <ul className="list-style-one">
															...
															<li>Gum Surgeries</li>
															<li>Preventive dentistry for children</li>
															<li>Orthodontic Braces</li>
															<li>Special dental care for diabetic and cardiac patients</li>
															<li>Teeth Bleaching and Teeth whitening</li>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                        ...
				                                        <h3 className="pt-4">Dental Problems</h3>
				                                        <ul className="list-style-one">
				                                            <li>Loss of Tooth</li>
				                                            ...
				                                            <li>Bleeding Gums</li>
				                                            <li>Teeth Decay</li>
				                                            <li>Dental Traumatic Injuries</li>
				                                            <li>Misalignment of Teeth</li>
				                                            <li>Delay of Teething in Children</li>
				                                        </ul>
				                                    </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="dental">Dental</a></li>
				        ...
				        <h4 className="text-center">Our Doctors</h4><br></br>
				            <div className="row">
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.T.Manivannan MDS.,</a></h4>
				                            <span className="designation">Consultant Dentist</span>
				                        </div>
				                    </div>
				                </div>
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.Midhun BDS., MDS (Faciomaxillary)</a></h4>
				                        	 <span className="designation">Consultant Dentist</span>
				                        </div>
				                    </div>
				                </div>
				            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
			                    <div className="inner-box">
			                        ...
			                        <div className="info-box">
			                            <h4 className="name"><a>Dr.Abirami MDS.,</a></h4>
			                         <span className="designation">Consultant Dentist</span>
			                        </div>
			                    </div>
			                </div>
