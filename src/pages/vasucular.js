				    ...
				    <section className="page-title"style={{backgroundImage: `url("assets/images/department.jpg")`}}>
				        <div className="auto-container">
				            <div className="title-outer">
				                <h1>Vasucular Surgery</h1>
				                <ul className="page-breadcrumb">
				                    <li><a href="/">Home</a></li>
				                    <li><a href="specialities">Specialities</a></li>
				                    <li><a href="vascular">Vasucular Surgery</a></li>
				                </ul> 
				            </div>
				        </div>
				    </section>
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Vasucular Surgery</h2>
				                                <span className="theme_color">VASCULAR SURGERY FOCUSES ON EFFECTIVE DIAGNOSIS AND TREATMENT OF DAMAGED OR DISEASED BLOOD VESSELS, ARTERIES, AND VEINS.</span>
				                            </div>
				                            <div className="two-column">
				                                <div className="row">
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    <p>The vascular surgery department of Devaki Specialty Hospital deals with the diseases of the arteries, veins and lymphatic systems. Vascular and endovascular surgeons at Devaki Specialty Hospital treat blood vessel and lymphatic system conditions (vascular diseases) fully and restore to maximum health and well-being. Experience and expertise, coupled with our team approach and research prowess enable to deliver success rates at Devaki.</p>
							                            <h3>Facilities</h3>
							                            <ul className="list-style-one">
				                                            <li>Peripheral Angioplasty & Stenting</li>
															<li>Peripheral Bypass</li>
															<li>Aneurysm Repair</li>
															<li>Carotid Artery Surgery</li>
															<li>Thoracic outlet Surgery</li>
															<li>Varicose Angioplasty</li>
															<li>Access Surgery</li>
															<li>Diabetic foot Surgeries</li>
														</ul>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="vasucular">Vascular Surgery</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.S.K.Balaji M.S., M.Ch</a></h4>
				                        	 <span className="designation">Consultant Vascular Surgeon </span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.Saravana Robinson M.S., M.Ch</a></h4>
				                         <span className="designation">Consultant Vascular Surgeon</span>
				                        </div>
				                    </div>
				                </div>
