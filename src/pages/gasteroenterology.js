				...
				<div className="page-wrapper">
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Gasteroenterology</h2>
				                                <p>The Department of Gastroenterology &Hepatobiliary services comprises medical & surgical gastroenterologists. Along with the support of Interventional Radiologists, critical care specialists are able to deliver a team based protocol driven solution for all complex gastrointestinal & Hepatobiliary diseases.</p>
				                            </div>
				                                <div>
				                                <div className="row">
				                                	<div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                        <h4>Overview</h4>
				                                        <p>The department has state-of-the-art equipment such as endoscopic ultrasound, 16 channel high-resolution manometric system, capsule endoscopy & PH manometry. The department specializes in the treatment of complex gastrointestinal diseases such as pancreatitis, liver failure, GI malignancies and inflammatory bowel disease.
															The department has successfully completed liver transplantation and other complex GI surgeries such as liver and pancreatic resection. The uses of technology with surgical skill have ensured results in keeping with international standards.</p>
				                                        <h4>Service & Facilities</h4>
				                                        <p>To detect all motility disorders of oesophagus and intestine, colorectal motility and rectal incontinence etc.</p>
				                                        <p>24 hours ambulatory pH monitoring with 6 channel impendence monitoring is first of its kind in South India and will be a great help in evaluating patients with GERD on and off PPI.</p>
				                                        <p>Wireless Capsule endoscopy and Double Balloon Enteroscopy for rapid diagnosis and day-care treatments to help patients with small intestine lesions.</p>
				                                        <p>Endosonography, for advanced diagnosis of cancers or to perform cysto-gastrostomy via endoscope when there is a pus or fluid collection in lesser sac, completes the spectrum.</p>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                        ...
				                                        <ul className="list-style-one">
															...
															<li>ERCP, Endosonography, DBE</li>
															<li>Enteral stenting</li>
															<li>Achalasia Dilatation</li>
															<li>Polypectomy, PEG, Liver Biopsy</li>
															<li>CPN, Glue Injection,Variceal Ligation, Colonoscopy</li>
				                                        </ul>
				                                    </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="gasteroenterology">Gasteroenterology</a></li>
				   ...
				   {/*} <section className="clients-section alternate">
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.Vijay Shankar M.D.,D.M., (Gastro)</a></h4>
				                        	 <span className="designation">Consultant Medical Gasteroenterology</span>
				                        </div>
				                    </div>
				                </div>
				            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
			        ...
			        <div className="footer-bottom">
			            <a href="gasteroenterology"><div className="scroll-to-top scroll-to-target" data-target="html"><span className="fa fa-angle-up"></span></div></a>
...
export default Gasteroenterology;