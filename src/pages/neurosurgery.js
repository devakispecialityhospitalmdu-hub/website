				                                ...
				                                <div className="row">
				                                    ...
				                                    <span className="theme_color"><b>General</b></span>
				                                        <ul className="list-style-one">
				                                            <li>24 hr neurosurgery services. Consultants available for all emergencies</li>
															<li>Dedicated neurosurgical ICU with 6 ventilators &  trained neuro nurses</li>
															<li>Dedicated Neuro rehabilitation unit</li>
															<li>24 hr CT & MRI</li>
															<li>Dedicated Neurosurgical operation theatre with microscope, endoscope and C Arm</li>
															<li>Round the clock sub-specialty back up</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Vascular Neuro-Surgery</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Aneurysm Clipping & Coiling for ruptured aneurysms</li>
															<li>AVM management</li>
															<li>Micro vascular decompression for trigeminalneuralgia</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Brain Tumors</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Awake Craniotomy</li>
															<li>Meningiama Surgery</li>
															<li>Gliama Surgery</li>
															<li>Accrestic Neuroma surgery</li>
				                                        </ul>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                    	...
				                                    	<span className="theme_color"><b>Trauma</b></span>
				                                        <ul className="list-style-one">
				                                            <li>24 hr availability of consultants</li>
															<li>Decompressive craniotomy</li>
															<li>Computer assisted skull reconstruction</li>
															<li>Burr holex surgery for chronic subdural hematoma</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Surgery For Stroke</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Hematoma evacuation</li>
															<li>Surgery for cerebellar infarcts</li>
															<li>Dedicated Neuro-Intensive Care Unit: The Neuro-Intensive Care Unit (NICU) at Devaki Specialty Hospital offers the advanced levels of tertiary neuroscience care in Madurai.</li>
															<li>Sleep laboratory to effectively manage sleep-related problems</li>
															<li>Nerve conduction machine</li>
															<li>Stereo EEG</li>
				                                        </ul>
				                                    </div>
				                                </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="neurosurgery">Neuro Surgery</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.Sri Saravanan M.S., M.Ch (Neuro)</a></h4>
				                        	 <span className="designation">Consultant Neuro Surgeon </span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
