				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                ...
				                                <span className="theme_color">WIELDING THE KNIFE FOR HOPE AND CURE.</span>
				                            	<p>Traditionally, surgery had been regarded as one of the most important weapons in the fight against cancer, and it’s status is still unchanged. But rather than trying to remove more and more to push for a possible cure, conserving functioning tissue without compromising cure has become the key to successful cancer surgery.</p>
				                            	<p>The Department of Surgical Oncology at DEVAKI SPECIALITY HOSPITAL offers treatments for all types of cancer. It is backed by well-equipped radiology and imaging facilities. This department is manned by site-specific specialists. It also has state-of-the-art operation theatres and intensive care units.</p>
				                            	<p>The Department of Surgical Oncology routinely performs procedures in patients with head and neck, breast and gynecological malignancies, and soft tissue tumors. All cases are planned by the tumor board, which is a multidisciplinary board including Radiation and Medical Oncologists. At DEVAKI CANCER CARE CENTER we follow evidence-based management protocols which are accepted worldwide.</p>
				                            </div>
				                                ...
				                                <div className="row">
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">	
							                            ...
							                            <ul className="list-style-one">
															...
															<li>Breast malignancies</li>
															<li>Gynecological malignancies</li>
															<li>Skin and Soft tissue tumors</li>
															<li>Thoracic malignancies</li>
															<li>Urological malignancies</li>
															<li>GI malignancies</li>
															<li>Screening of all cancers</li>
															<li>Dedicated breast clinic</li>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="surgicalonco">Surgical Oncology</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.Saravan Boopathy – M.S., M.Ch (Gastro)</a></h4>
				                        	 <span className="designation">Consultant Surgical Gastroenterologist</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    {/*<div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.M.Ramesh M.S., M.Ch. </a></h4>
				                         <span className="designation">Consultant Surgical Oncologist </span>
				                        </div>
				                    </div>*/}
				                </div>
			                </div>
