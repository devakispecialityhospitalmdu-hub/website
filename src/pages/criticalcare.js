				        ...
				        <div className="auto-container">
				            <div className="title-outer">
				                ...
				                <ul className="page-breadcrumb">
				                    ...
				                    <li><a href="criticalcare">Critical Care</a></li>
				                </ul> 
				            </div>
				        </div>
				    </section>
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                ...
				                                <p>Critical care is provided to patients who need immediate care for their life-threatening health conditions – chronic illnesses, life-threatening trauma, accidental injuries, burn injuries, and other emergency situations like organ failure, respiratory failure, neurological emergencies, liver disorders and failures, sepsis, overdose and poisoning, Asthma and COPD, multisystem trauma, complications arising out of pregnancy and tropical diseases.</p>
				                                <div>
				                                <div className="row">
				                                	<div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                        <h4>Overview</h4>
				                                        <p>Critical Care Unit (CCU) at Devaki Specialty Hospitals has an array of specialized and sophisticated Intensive Care Units to provide responsive care for critically ill patients. The patient’s condition is constantly monitored in these specialized intensive care units. The unit also has quick access to laboratory, diagnostic and radiology departments for ensuring 24/7 availability of these services at the disposal of patients. Our CCU’s adhere to universally accepted safety norms and a strong audit culture to make critical care safe for the patients.</p>
				                                        <p>Round the clock care is offered to the patients by experienced and trained critical care specialists, critical care nurses, pulmonologists, respiratory therapists, clinical pharmacists, respiratory care technicians, and support staff. Our specialists use sophisticated diagnostic, monitoring and therapeutic technology with an aim to revive and restore organ system functioning and overall condition of the patient and to treat the patient’s underlying illness or injury diligently.</p>
				                                        <h4>Procedures & Treatments</h4>
				                                        <p>Provides state of art facilities including ventilators, monitors, CRRT, Cardiac output monitoring facilities.</p>
				                                        <ul className="list-style-one">
				                                            <li>Standard Operating policies and Infection Control Practices for enhanced patient safety benchmarked to International Standards.</li>
				                                            <li>24/7 coverage of ICU by consultants.</li>
				                                        </ul>
				                                    </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="criticalcare">Critical Care & Toxicology</a></li>
