				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                ...
				                                <span className="theme_color">A LIFESTYLE DISORDER NEEDN’T BE A LIFELONG CONDITION.</span>
				                            </div>
				                            <h4>Overview</h4>
	                                			<p>Obesity is a condition that is steadily on the rise – both among adults as well as children. It occurs when the body weight exceeds the ideal body weight by 20% and waistline exceeds 4 inches. Obesity can often signal the onset of medical conditions such as diabetes, hypertension, arthritis, infertility, sleep apnea, kidney and heart disease.</p>
	                                			<p>We conduct obesity awareness programs and seminars at colleges, social clubs such as the Lions Club, senior citizens’ clubs, hospitals and offices in the public sector. We also conduct camps in association with the Lions Club and check-up camps for free.</p>
				                            <div className="two-column">
				                                <div className="row">
				                                 <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                        <h4>Facilities</h4>
								                        <p>We house a whole body gymnasium for our patients to exercise and stay healthy.</p>
								                        <ul className="list-style-one">
							                                <li>Water aerobics for senior citizens and arthritic patients</li>
							                                <li>Weight loss exercise program</li>
							                                <li>Stress management</li>
							                                <li>Meditation and yoga class</li>
							                                <li>Special food preparation classes for obese patients and obese children</li>
							                                <li>Nutrition and wellness</li>
							                                <li>Weight management for adults and children</li>
							                <li>Neurobic – brain exercises</li>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                               <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="bariatric">Bariatric Surgery</a></li>
