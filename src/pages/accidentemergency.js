				        ...
				        <div className="auto-container">
				            <div className="row clearfix">
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                ...
				                                <span className="theme_color">PROVIDING IMMEDIATE LIFE SUPPORT AND CARE FOR THE MOST CRITICAL, HIGH RISK AND LIFE THREATENING MEDICAL CONDITIONS AND TRAUMA CARE.</span>
				                            </div>
				                            <h4>Overview</h4><br></br>
                                <p>Devaki specialty hospital is best in trauma care, our accident and emergency department provides frontline emergency care services at par with international standards. since time is critical during emergencies, we ensure zero waiting time and accurate treatment to every patient. Our golden hour care has been widely applauded as a life-saver.</p>
                                <p>The department is on its toes 24/7. It is fully-equipped with advanced technological facilities and is stocked with all emergency drugs. We have a success rate of over 70% in reviving cardiac arrest patients. The staffs is specially trained to offer urgent and expert care in cases like heart attacks, cardiac arrest symptoms, cerebrovascular accidents, strokes, accidents and trauma, and other emergency situations. The personnel is also trained in resuscitation, first aid for poisoning, ventilator technology and other requisites of Accident and Emergency care.</p>
                                <p>The motto of Devaki specialty hospital’s accident and emergency department is ‘providing immediate life support and care for the most critical, high risk and life threatening medical conditions and trauma care.. Which is why we don’t just treat: we deliver care with compassion, respect, and individual attention.</p>
                                <p>The objective of our emergency department is to offer quick responsive emergency care to save lives. Fastest emergency response can save lives</p>
                                ...
                                <ul className="list-style-one">
	                                <li>Management of acute medical, surgical, cardiac, pediatric and neonatal emergencies</li>
	                                <li>Care to all trauma victims including polytrauma following RTAs, i.e. falls or assault</li>
	                                <li>Acute burns and poisoning management</li>
	                                <li>Disaster management</li>
	                                <li>Advanced ambulance services for patient.</li>
	                                <li>Coverage by well-trained emergency physicians & nurses 24/7 , 365 days</li>
	                            </ul>
		                        <br></br>
		                        ...
		                        <ul className="list-style-one">
	                                <li>Emergency room works 24/7</li>
	                                <li>Advanced and basic life support ambulance and pre-hospital care</li>
	                                <li>Advanced resuscitation area</li>
	                                <li>Dedicated Stroke, Cardiac and Trauma teams</li>
	                                <li>Poisoning management and care</li>
	                                <li>Disaster management</li>
	                                <li>Ventilator facility</li>
	                                <li>Point of care Stat lab in ED</li>
	                                <li>Point of care Radio diagnostics in ED</li>
	                                <li>Experienced & fully-trained emergency medicine specialists and paramedical staff</li>
	                            </ul>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                               <ul className="services-categories">
				                                	<li className="active"><a href="accidentemergency">Accident and Emergency</a></li>
