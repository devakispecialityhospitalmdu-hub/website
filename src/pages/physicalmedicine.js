				        ...
				        <div className="auto-container">
				            <div className="title-outer">
				                ...
				                <ul className="page-breadcrumb">
				                    ...
				                    <li><a href="physicalmedicine">Physical Medicine and Rehabilitation</a></li>
				                </ul> 
				            </div>
				        </div>
				    </section>
				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                ...
				                                <p>The Department of Physical Medicine and Rehabilitation at Devaki Specialty Hospital works towards restoring the functioning of the body, reducing the impact of dysfunction, disability and pain which might have been caused through trauma and disease. The Physiotherapy department is one of the largest in its class and works across all sub-specialties. It is also equipped with all latest equipment’s. We have a qualified and highly experienced team of physiotherapists providing OPD services (direct and referral) and IPD services (wards and intensive care units) with treatment procedures conforming to exact international standards.</p>
				                            </div>
				                            ...
				                            <div className="two-column">
				                                <div className="row">
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
					                                    <p>The core idea at the Department of Physical Medicine and Rehabilitation is to ensure that rehabilitation is achieved within the shortest period possible, making life near normal for the patient at the earliest. The physiotherapists provide a wide range of therapies after examination, tailored to suit individual needs. The department strives to improve each patient’s mobility and health, and to reduce the risk of injuries.</p>
					                                    <p>Rehabilitation offers high-quality multidisciplinary rehabilitation services. The department offers inpatient, outpatient and rehabilitation services as well as home care programs.</p>
					                                    <p>After a major illness, injury or surgery, you may find it difficult to return to the way you previously lived. Whether it’s your strength, mobility, ability to communicate or thinking ability that is affected; your everyday life can be impacted by your new health status.</p>
				                                    	<h3>Facilities</h3>
				                                        <ul className="list-style-one">
				                                            <li> <span className="theme_color">Electrotherapy</span> - SWD / IFT / Ultrasonic / MS stimulator, T.E.N.S., Paraffin wax-bath, Cryotherapy</li>
															<li> <span className="theme_color"> Diagnostic </span> - SD curve / MS testing / ADL assessment</li>
															<li> <span className="theme_color">Mechanical</span> - Traction – Cervical / Lumbar / Pelvic / CPM for lower extremity, Tiltable, Rowing, Treadmill</li>
															<li> <span className="theme_color">Manual mobilization therapies</span> - Mobilization couch with specific features for mobilization</li>
															<li> <span className="theme_color">Exercise therapy</span> - Active / Assisted / Passive / Resisted / Graded resisted exercises, PNF techniques, Suspension therapy, Theraband / Tubes exercises</li>
															<li> <span className="theme_color">Chest physiotherapy</span> - Assessment of pulmonary functions, Therapeutic functions, Postural, Drainage, Therapeutic, Interventional physiotherapeutic procedures, Nebulization, breathing exercises, Incentive spirometer, Humidification, home care and follow ups</li>
															<li> <span className="theme_color">Gynae / Obstetric</span> - Antenatal and Postnatal exercises, Postural correction and awareness, Fitness – Assessment and Improvement, etc.</li>
															<li> <span className="theme_color">Postoperative cardiac surgeries</span> - Pre and post-operative physiotherapeutic exercise for cardiac surgery patients including breathing exercises, chest maneuvers, Humidification, Nebulization, Incentive spirometers, Limb physiotherapy and Cardiac rehab phase I-IV</li>
															<li> <span className="theme_color">Neurological disorders</span> - Proper positioning of the limbs (Anti synergic patterns), general mobility and strengthening exercises, PNF and Bobath</li>
															<li> <span className="theme_color">ICU post-surgical care</span> - Chest physio and general mobility exercises, Incentive spirometer exercises, bronchial hygiene, proper positioning of the operative side / part and ambulation</li>
															<li> <span className="theme_color"> Oncology and Palliative care</span> - Physiotherapy in the field of Oncology and Palliative care is a continuously evolving and developing specialty. </li>
															<li> The aim of Physiotherapy and Rehabilitation is to maximize independence and dignity and reduce the extent of cancer and other life-limiting illnesses which interfere with an individual’s physical, psychosocial and economic functioning.</li>
															<li> Physiotherapy focuses on the care and treatment of a wide range of physical problems, which may optimize and enhance the patients’ quality of life</li>
				                                        </ul>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                    	...
				                                    	<h3>The therapies include</h3>
				                                        <ul className="list-style-one">
				                                            <li> <span className="theme_color">Manual therapy</span> - Stretching, Manual resistance training, Joint mobilization and manipulation, Manual lymphatic drainage (Post lymphedema), Chest physiotherapy, etc.</li>
															<li> <span className="theme_color">Electrotherapy techniques</span> - Short-wave-diathermy, Ultrasound therapy (1mhz, 3mhz), Pelvic and cervical traction (continuous and intermittent), Interferential therapy, Wax-bath, Electrical muscle stimulator, T.E.N.S, Slim-up, Vacuum therapy, etc.</li>
															<li> <span className="theme_color">Exercises</span> - Posture training, Muscle strengthening, Cardio-vascular training and stretching.</li>
															<li> <span className="theme_color">Other services</span> - offered by the department include Advice orthosis and prosthesis (post amputation), and offering of information regarding equipment aids (wheelchairs, walking aids), taping and splinting.</li>
				                                        </ul>
				                                    </div>
				                                </div>
				                            </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="physicalmedicine">Physical Medicine & Rehabilitation</a></li>
