				                    ...
				                    <div className="service-detail">
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            ...
				                            <h3>Overview</h3>
				                            <p>Devaki Specialty Hospital is a specialized center with state-of-the-art facility that offers specialised services for comprehensive management of musculoskeletal disorders in adults and children. The department has an exceptional team of doctors comprising of top orthopaedic surgeons who have the experience and expertise to handle all orthopaedic emergencies and complex surgeries. Our department caters to a wide range of subspecialties including joint replacements, arthroscopy & sports medicine, paediatricortho, hand surgery, ortho oncology apart from a dedicated trauma and accident services. </p>
				                            <div className="two-column">
				                                <div className="row">
				                                <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                        <figure className="image pb-2"><a className="lightbox-image"><img src="assets/images/cardiology/cardiology_2.jpg" alt=""/></a></figure>
				                                    	<h3>Procedures & Treatments</h3>
				                                    <span className="theme_color"><b>Joint Replacement</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Primary / Complex - Hip & knee replacement</li>
															<li>Shoulder & elbow replacement</li>
															<li>Revision - Hip & Knee replacement</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Fractures and Dislocation</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Intra-articular fractures</li>
															<li>Multiple Fractures</li>
															<li>Poly trauma</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Arthroscopy</b></span>
				                                        <ul className="list-style-one">
				                                            <li>ACL / PCL reconstruction</li>
															<li>Meniscal repair</li>
															<li>Shoulder arthroscopy</li>
															<li>Multiple Ligament Injury Complex</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Geriatric Ortho</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Hip & Knee Surgeries</li>
															<li>Wrist Injuries</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Hand Surgery</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Carpal tunnel release</li>
															<li>Tendon repair</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Spine</b></span>
				                                        <ul className="list-style-one">
				                                            <li>SX - Traumatic Spine Fracture</li>
															<li>Open PLIF/TLIF</li>
															<li>MIS - PLIF/TILF</li>
															<li>anterior spin surgeries</li>
															<li>deformity correction ( scoliosis / kyphosis )</li>
															<li>micro - lumbar / cervical disCectomies</li>
															</ul>

				                                    </div>
				                                  
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    <p>We have a 24 hr trauma & accident service catering to all varieties of fractures, dislocation, compound injuries and vascular injuries.</p>
				                                    <p>Our joint replacement team uses advanced techniques such as computer navigation, patient-specific instrumentation, hi-flex knees (improved range of movement), and are experts in revision replacement surgeries.</p>
				                                    <ul className="list-style-one">
				                                        <li>World-class Operative Rooms with Laminar Airflow</li>
				                                        <li>24 hours Emergency Care and Casualty Facility</li>
			                                        </ul>
			                                        <h3 className="pt-5">Major Services</h3>
				                                        <ul className="list-style-one">
				                                            <li>Hip, knee and shoulder replacement surgeries</li>
															<li>Arthroscopy & Sports medicine procedures</li>
															<li>Pediatric Orthopedic & cerebral palsy clinics</li>
															<li>Dedicated hand surgery unit for major limb injuries</li>
															<li>Reconstructive surgery for congenital deformities</li>
															<li>Micro vascular surgeries</li>
															<li>Poly trauma Care complex fracture fixation</li>
															<li>Ilizarov limb reconstruction procedure</li>
															<li>Keyhole fixation of hip fracture of the elderly</li>
															<li>Osteoporosis clinic and BMD assessment</li>
															<li>Back ache clinic</li>
															<li>Arthritis clinic</li>
															<li>Complex spine surgeries</li>
															<li>Minimally invasive spine surgeries</li>
															<li>Scoliosis surgery</li>
															<li>Fracture spine fixations</li>
															<li>Dedicated 24 hours trauma ICU</li>
				                                        </ul>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="orthopedics">Orthopedics</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.M.Manoj Deepak M.S., Ortho</a></h4>
				                            <span className="designation">Consultant Orthopedic Surgeon</span>
				                        </div>
				                    </div>
				                </div>
				                <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a >Dr.Karthikeyan M.S., Ortho. DA.,</a></h4>
				                        	 <span className="designation">Consultant  Orthopedic & Anesthetist</span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-3 col-md-6 col-sm-12 wow fadeInUp">
