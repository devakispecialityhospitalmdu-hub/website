				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Pediatric Surgery</h2>
				                                 <span className="theme_color">Providing Quality Treatment For Neonatal Children And Adolescents</span>
				                            </div>
				                            ...
				                            <div className="two-column">
				                                <div className="row">
				                                    ...
				                                    <div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                    	<h3>Overview</h3>
				                            			<p>Children are not just small adults. They cannot say what is bothering them. They require lovable care from specialised Pediatric team for correct diagnosis and treatment. Our hospital team of doctors in the department of Pediatrics & Pediatric Surgery are committed to provide quality medical and Surgical Care to Kids.</p>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="pediatric">Pediatric Surgery</a></li>
