				                ...
				                <div className="content-side col-xl-9 col-lg-8 col-md-12 col-sm-12 order-2">
				                    <div className="service-detail">
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="images-box" style={{"width" : "1070px" , "marginRight" : "50px"}}>
				                            <figure className="image wow fadeIn"><a href="assets/images/resource/service-single.jpg" className="lightbox-image" data-fancybox="services"><img src="assets/images/carousel/3.jpg" alt=""/></a></figure>
				                        </div>
				                        <div className="content-box">
				                            <div className="title-box">
				                                <h2>Medical Oncology</h2>
				                                <span className="theme_color">WE FIGHT TOGETHER WITH CANCER!</span>
				                                <h4>Overview</h4>
				                                <p>Cancer patients at Devaki Specialty Hospital have access to the best therapies and latest treatment options, including clinical trials and specialized care to fight your cancer.
													Our cancer patients receive treatment and services from specialists in Genetics, Surgery Radiation Oncology, Medical Oncology, chemotherapy, Pathology and Imaging along with 
													excellent state of art ICU bed up. The dedicated team of surgical oncologists works with other specialists to develop integrated, individualized treatment plans for patients at each stage of their disease.</p>
				                            ...
				                            <p>From cancer prevention screenings, initial cancer diagnosis or a second opinion to treatment options and survival, Devaki Speciality Hospital is here to care for you because, we prove ourself as best hospital for cancer treatment.</p>
				                                ...
				                                <div className="row">
				                                    ...
				                                    <h3>Service and Facilities</h3>
				                                        <ul className="list-style-one">
				                                            <li>Biological Targeted Therapy/ Chemotherapy/ Immunotherapy</li>
															<li>Regional Chemotherapy like Intrapleural, intraperitoneal, intra-arterial, intravesicular, intrathecal</li>
															<li>Chemoport insertion</li>
															<li>Bone Marrow studies</li>
															<li>All major/ minor biopsies/ FNAC</li>
															<li>CT/ Ultrasound-guided procedures</li>
															<li>Clinical Trials/ Research</li>
															<li>Hereditary cancer screening</li>
															<li>Screening for Breast/ Cervix/ Prostate/ Colon (Cervix Cancer) etc</li>
															<li>Immunization for Human Papilloma Virus, HBV etc</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Head and Neck Cancers</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Oral Cancers</li>
															<li>Thyroid Cancers</li>
															<li>Parotid Tumors/ Salivary Gland Tumors</li>
															<li>Laryngeal Cancers</li>
															<li>Parathyroid Tumors</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Thoracic Cancers</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Oesophageal Cancers</li>
				                                            <li>Thoracic wall Tumors</li>
				                                            <li>Lung Tumors, Mediastinal Tumors</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Breast Cancers</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Mastectomy</li>
															<li>Breast Conserving Surgery (Day care surgery)</li>
				                                        </ul>
				                                        <span className="theme_color"><b>Gastrointestinal Cancers</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Stomach Cancers</li>
															<li>Laparoscopic Cancer Surgery</li>
															<li>Colorectal Cancers</li>
															<li>Liver, Biliary Tract, & Pancreatic Tumors</li>
															<li>Gall Bladder Cancers</li>
															<li>Small Intestinal Tumors</li>
				                                        </ul>
				                                        
				                                    </div>
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12 pb-2">
				                                    	...
				                                    	<span className="theme_color"><b>Genitourinary Cancers</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Penile Cancers</li>
															<li>Prostate Cancers</li>
															<li>Urinary Bladder Cancers</li>
															<li>sSupra renal Tumors</li>
															<li>Kidney Tumors</li>
															<li>Testicular Cancers</li>
				                                        </ul>
				                                        <span className="theme_color"><b> Gynecological Cancers</b></span>
				                                        <ul className="list-style-one">
				                                            <li>Ovarian Cancers</li>
															<li>Endometrial Cancers</li>
															<li>Cervix, Vagina & Vulvar Cancers</li>
				                                        </ul>
				                                         <span className="theme_color"><b>Reconstructive Surgeries mainly for Head & Neck Cancers, for Bone and soft tissue tumors involving Micro vascular surgeons.</b></span><br></br>
				                                         <span className="theme_color"><b>Bone and Soft Tissue Tumors- Limb Conserving Surgeries</b></span><br></br>
				                                          <span className="theme_color"><b>Chemo port Insertion Procedure</b></span>
				                                    </div>
				                                </div>
				                            </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li className="active"><a href="oncology">Medical Oncology</a></li>
				            ...
				            <div className="row">
				                ...
				                <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
				                    <div className="inner-box">
				                        ...
				                        <div className="info-box">
				                            <h4 className="name"><a>Dr.T.Deenadayalan M.D., D.M., (Oncology)</a></h4>
				                        	 <span className="designation">Consultant Medical Oncologist </span>
				                        </div>
				                    </div>
				                </div>
					            <div className="team-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
