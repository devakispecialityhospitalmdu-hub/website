				                       ...
				                       {/*} <div className="images-box">
				                        ...
				                        <div className="content-box">
				                            <div className="title-box">
				                                ...
				                                <p>Devaki Specialty Hospital offers diabetes screenings and resources to prevent manage Diabetes or pr-diabetes. Our team of expert doctors and trained medical staff offer high-quality care for the various types to treat of diabetes. To tweet complications of Diabetes.</p>
				                                <div>
				                                <div className="row">
				                                	<div className="text-column col-xl-6 col-lg-12 col-md-12">
				                                        <h4>Overview</h4>
				                                        <p className="pt-2">The modern sedentary lifestyle has contributed to the rapid rise of the disease and it is estimated that today, more than 62 million Indians suffer from diabetes and the numbers are projected to touch 100 million by 2035.</p>
				                                        <p>Key aspects and advantages of treatment at DSH include, Certified educators to offer diabetes counselling. Dietitians to provide customized meal plans.</p>
				                                        <p><b>A Multidisciplinary approach which ensures expert care for all diabetic complications, which includes</b></p>
				                                        <ul className="list-style-one">
				                                            <li><span className="theme_color">Foot care</span> - Screening for high-risk cases and management of foot ulcers.</li>
				                                            <li><span className="theme_color">Kidney Care</span> - Care to prevent delay the development of diabetic kidney disease.</li>
				                                            <li><span className="theme_color">Weight Management</span> - Services include appropriate nutrition and robotic Bariatric surgery.</li>
				                                            <li><span className="theme_color">Diabetes in Children</span> - The paediatric, nutrition and other allied departments at SNHRC lend their expertise in treating and caring for minors with the disease.</li>
				                                        </ul>
				                                        
				                                        <h4>Primary Care</h4>
				                                        <p className="pt-2">Diabetes screenings are conducted for patients and high-risk groups (eg.: people with a family history of diabetes, obesity, sedentary lifestyle and so on).</p>
				                                        <h4>Secondary Care</h4>
				                                        <p className="pt-2">Diabetics are treated and monitored to prevent longstanding or uncontrolled diabetic complications.</p>
				                                    	<h4>Tertiary Care</h4>
				                                    	<p className="pt-2">The finest specialists manage and monitor cases of severe diabetic complications like chronic renal failure, proliferative retinopathy, erectile dysfunction and diabetic foot ulcers.</p>
				                                    	<p><b>To reduce your risk of type 2 diabetes.</b></p>
				                                        <h4>Special treatment options</h4><br></br>
				                                        <ul className="list-style-one">
				                                            <li>Insulin pump therapy</li>
															<li>Special diabetic footwear</li>
															<li>Continuous Glucose Monitoring System (CGMS)</li>
															<li>Ambulatory Glucose Profile</li>
				                                        </ul>
				                                    </div>
				                                    ...
				                                    <div className="image-column col-xl-6 col-lg-12 col-md-12">
				                                    	...
				                                    	<h4>Facilities</h4>
				                                        <ul className="list-style-one">
				                                            <li>Modern laboratory services</li>
				                                            <li>Continuous glucose monitoring</li>
				                                            <li>Insulin pump services</li>
				                                            <li>Diet Clinic</li>
				                                            <li>Stress Clinic</li>
				                                            <li>Foot Clinic</li>
				                                        </ul>
				                                        
				                                        <h4 className="pt-2">Check-Ups Include</h4>
				                                        <ul className="list-style-one">
				                                            <li>Nerve conduction study</li>
															<li>Urine PCR</li>
															<li>Tests for microalbumin</li>
															<li>Peripheral vascular screening</li>
															<li>Heart check-ups</li>
															<li>Fundus photographs</li>
															<li>Autonomic nervous system study</li>
				                                        </ul>
				                                    </div>
				                        ...
				                        <div className="sidebar-widget categories scrolllist">
				                            <div className="widget-content">
				                                <ul className="services-categories">
				                                    ...
				                                    <li  className="active"><a href="diabetology">Diabetology</a></li>
