				     ...
				     <section className="page-title" style={{backgroundImage: `url("assets/images/contact/header.jpg")`}}>
				        <div className="auto-container">
				            <div className="title-outer">
				                <h1>Patients Guidelines</h1>
				                <ul className="page-breadcrumb">
				                    <li><a href="/">Home</a></li>
				                    <li>Patient Care Services</li>
				                    <li>Rights and Responsibilites</li>
				                </ul> 
				            </div>
				        </div>
				    </section>
				            ...
				            <div className="skill-column1">
				                <div className="inner-column">
				                    <div className="sec-title">
				                    	<h3>Patient Rights</h3><br></br>
				                        <span className="sub-title"><b>Privacy</b></span>
				                        <div className="text">When the patient receives medical treatment, he/she has rights for privacy. A female patient may be examined by a male doctor only in the presence of a female Staff Nurse / escort.</div>
				                        <span className="sub-title"><b>Treatment refusal</b></span>
				                        <div className="text">You have the right to accept or refuse any procedure, drug or treatment, and to be informed of the consequences of any such refusal.</div>
				                        <span className="sub-title"><b>Consent</b></span>
				                        <div className="text">You have the right to get enough information about any proposed treatment or procedure to make an ‘informed consent’- that is, you should know enough about the expected benefits, risks, alternative treatment options, and time needed for recovery to decide if you want that treatment or procedure.</div>
				                        <span className="sub-title"><b>Freedom from Abuse</b></span>
				                        <div className="text">Patients have the right to be free from mental, physical, sexual and verbal abuse, neglect and exploitation from staff, visitors or other patients.</div>
				                        <span className="sub-title"><b>Confidentiality</b></span>
				                        <div className="text">You have the right to have your healthcare information protected. Information concerning one’s health and treatment may only be disclosed with informed consent, except when required in terms of any law or an order of the court.</div>
				                        <span className="sub-title"><b>Complaints or Suggestions</b></span>
				                        <div className="text">You have the right to bring to the notice of the management regarding any problem or complaints with respect to hospitality, treatment and medications in the hospital through the suggestion box or directly by contacting the patient representative or Department of Quality for cases including physical/ verbal abuse or neglect.</div>
				                        <span className="sub-title"><b>Cost Of Treatment</b></span>
				                        <div className="text">You have the right to understand and receive information on the cost of treatment provided by the hospital.</div>
				                        <span className="sub-title"><b>Respectful Treatment Right</b></span>
				                        <div className="text">The right to considerate and respectful care with recognition of personal dignity and the right to express spiritual and cultural beliefs provided they do not interfere in others privacy and hospital operations. These Psychosocial, Cultural and Spiritual values will be given required consideration by the hospital.</div>
				                        <span className="sub-title"><b>Access to Medical Record</b></span>
				                        <div className="text">You have the right to seek and receive all the information necessary to understand your medical condition.</div>
				                        <span className="sub-title"><b>Information</b></span>
				                        <div className="text">You have the right to receive information about your medical problems, investigations, treatment plan, risks, benefits and likely outcome of any treatment or procedure. If you speak another language, assistance will be provided so you can make informed health care decisions.</div>
				                        <span className="sub-title"><b>Choices of Providers</b></span>
				                        <div className="text">You have the right to choose a particular health care provider for treatment provided that such choice shall not be contrary to the ethical standards. You have the right to know the name and speciality of any doctor or any other person who is caring for you.</div>
				                        <span className="sub-title"><b>Access to Emergency Services</b></span>
				                        <div className="text">If you have severe pain, injury, or sudden illness you have the right to receive screening and stabilization without prior authorization.</div>
			                    	</div>
				                </div>
				            </div>
				        </div>
				                    ...
				                    <div className="inner-column">
				                        <div className="sec-title">
				                            ...
				                            <ul className="list-style-one">
	                                            <li>To be punctual in keeping the appointments and inform if not turning up.</li>
	                                            <li>Not to ask for surreptitious bills and false certificates and/or advocate forcefully by unlawful means to provide with one.</li>
	                                            <li>To respect and be courteous to the doctors and other staff.</li>
	                                            <li>To be expected not to leave the hospital without intimating the Nurse in charge of the unit.</li>
	                                            <li>To provide accurate and complete information about his/her medical condition.</li>
	                                            <li>To clarify doubts if you do not understand what you have been told about your care or what you are expected to do.</li>
	                                            <li>To comply with the doctor’s treatment plan and instructions on diet, level of activity and other health care requirements.</li>
	                                            <li>To abide by the hospital/facility rules and regulations.</li>
	                                            <li>To provide accurate and complete information for insurance claims and work with the hospital to make payment arrangements.</li>
	                                            <li>To pay for the services billed in a timely manner.</li>
